...
public class BallWithShip extends Ball
{
    ...
    {
        new Fragment().actor(getActor()).pieces(10).pose("shell").createPoses("fragment");
        new Fragment().actor(getActor()).pieces(4).pose("contents").createPoses("contentsFragment");
    }
